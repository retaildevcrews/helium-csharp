...
namespace Helium.DataAccessLayer
{
    ...
    public static class DataAccessLayerExtension
    {
        ...
        /// <param name="cosmosUri">Cosmos Server URL</param>
        /// <param name="cosmosKey">Cosmos Key</param>
        /// <param name="cosmosDatabase">Cosmos Database</param>
        /// <param name="cosmosCollection">Cosmos Collection</param>
        /// <returns></returns>
        public static IServiceCollection AddDal(this IServiceCollection services, Uri cosmosUri, string cosmosKey, string cosmosDatabase, string cosmosCollection)
        {
